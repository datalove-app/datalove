...
from our responses from the ledger, we will create objs containing:
	- txn information:
	  - recipient
	  -
 */
...
Memo = {
  parseMemo: function(msg_json) {
    var memo = msg_json.transaction.Memos[0].Memo;
    var memoType = JSON.parse(utils.hexToString(memo.MemoType));
    var memoData = JSON.parse(utils.hexToString(memo.MemoData));
    return {
      memoType: memoType, 
      memoData: memoData
    };
  ...
  createMemo: function(type, data) {
    type = JSON.stringify(type);
    data = JSON.stringify(data);
    return {
      MemoType: utils.stringToHex(type),
      MemoData: utils.stringToHex(data)
    };
  }
}
...
// EXAMPLE OF SUCCESSFUL TRUSTSET TXN RESPONSE (to subscribing client)
/*
{ engine_result: 'tesSUCCESS',
  engine_result_code: 0,
  engine_result_message: 'The transaction was applied.',
  ledger_hash: 'DCF4D10A609997A02A1C48F6F40D410BF42DD41B225874E6428479F3415AFB4C',
  ledger_index: 385959,
  meta:
  { AffectedNodes:
  ...
  status: 'closed',
    transaction:
  { Account: 'gfD8yLiEtj25dchWsyWGQEVHgiVJQ5VZyZ',
    Fee: '15',
    Flags: 2147483648,
    LimitAmount:
    { currency: 'WFI',
      issuer: 'gPJi6qyeZB9pxvWkybEXzoSh7w5fyKtrmk',
      value: '100' },
    Sequence: 1,
      SigningPubKey: '51ED060B6BD42D0D8750B5B3C3EB31F8C8A5B4FEAF0547FE8EB852BE7E375A22',
    TransactionType: 'TrustSet',
    TxnSignature: '0976632B7D6E2742C6E27712F6F6D3A66A48044783C8D3A00164F531350DBCFC0345A43D038692A97AA7333893E3819D9E06E165A1422F6E88B46EB72177D90C',
    date: 479075760,
    hash: '116A1C12E46560F2056E74E837360CA52ACB9380906E56E4AE6D1BE71323F19A' },
  type: 'transaction',
    validated: true
}
 */

// EXAMPLE OF SUCCESSFUL TXN RESPONSE (sent to a subscribing client)
/*
{ engine_result: 'tesSUCCESS',
  engine_result_code: 0,
  engine_result_message: 'The transaction was applied.',
